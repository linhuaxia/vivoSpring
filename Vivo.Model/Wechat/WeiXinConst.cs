...
namespace Vivo.Model
{
    ...
    public class WeiXinConst
    {
        ...
        /// 微信开发者 AppId
        /// </summary>
        public static readonly string AppId = System.Configuration.ConfigurationSettings.AppSettings["WechatAppID"];

        /// <summary>
        /// 微信开发者 Secret
        /// </summary>
        public static readonly string Secret = System.Configuration.ConfigurationSettings.AppSettings["WechatAppSecret"];

        public static string GetOriginalWechatID()
        {
            if (AppId== "wxfb06bdc2368aaf3e")//测试号
            {
                return "gh_ee1468d1e464";
            }
            return "gh_76593f36446f";
        }

        /// <summary>
        /// V2:支付请求中 用于加密的秘钥Key，可用于验证商户的唯一性，对应支付场景中的AppKey
        /// </summary>
        public static string PaySignKey = "V2.PaySignKey V3不再用！";
        ...
        /// 用于验证 请求 是否来自 微信
        /// </summary>
        public const string Token = "ladygaga";

        /// <summary>
        /// 证书文件 路径
        /// </summary>
        public const string CertPath = @"D:\cert\apiclient_cert.pem";


        /// <summary>
        /// 证书文件密码（默认为商户号）
        /// </summary>
        public const string CertPwd = "";

        /// <summary>
        /// 支付完成后异步通知URL
        /// </summary>
        public const string tenpay_notify = ""; //支付完成后的回调处理页面,*替换成notify_url.asp所在路径
        ...
        /// 取消订单Url
        /// </summary>
        public const string WeiXin_Pay_UnifiedOrderCancel = "https://api.mch.weixin.qq.com/pay/closeorder";
        ...
        /// js TicketURL
        /// </summary>
        public const string JsTicketURL = "https://api.weixin.qq.com/cgi-bin/ticket/getticket?access_token={0}&type=jsapi";
